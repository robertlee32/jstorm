...
public interface IZkClient extends Closeable {
     ...
     * Close the client.
     *
     * @throws com.github.zkclient.exception.ZkInterruptedException if interrupted while closing
     */
    void close();
     ...
     * @throws com.github.zkclient.exception.ZkInterruptedException if the connection timed out due to thread interruption
     * @throws com.github.zkclient.exception.ZkTimeoutException     if the connection timed out
     ...
     * @param mode create mode {@link org.apache.zookeeper.CreateMode}
     * @return created path
     * @throws IllegalArgumentException if called from anything except the ZooKeeper event
     *                                  thread
     * @throws com.github.zkclient.exception.ZkException              if any ZooKeeper exception occurred
     */
     ...
     *
     * @param path zk path
     * @throws com.github.zkclient.exception.ZkInterruptedException   if operation was interrupted, or a required reconnection
     *                                  got interrupted
     * @throws IllegalArgumentException if called from anything except the ZooKeeper event
     *                                  thread
     * @throws com.github.zkclient.exception.ZkException              if any ZooKeeper exception occurred
     ...
     *
     * @param path the path for the node
     * @throws com.github.zkclient.exception.ZkNodeExistsException    if the node exists
     ...
     * Create a persistent node with empty data (null)
     * <p>
     * If the createParents is true, neither {@link com.github.zkclient.exception.ZkNodeExistsException} nor {@link com.github.zkclient.exception.ZkNoNodeException} were throwed.
     * </p>
     *
     * @param path          the path for the node
     * @param createParents if true all parent dirs are created as well and no
     *                      {@link com.github.zkclient.exception.ZkNodeExistsException} is thrown in case the path already exists
     * @throws com.github.zkclient.exception.ZkInterruptedException   if operation was interrupted, or a required reconnection
     *                                  got interrupted
     * @throws IllegalArgumentException if called from anything except the ZooKeeper event
     *                                  thread
     ...
     * @see {@link com.github.zkclient.IZkChildListener}
     */
     ...
     * @see {@link com.github.zkclient.IZkDataListener}
     */
     ...
     * @see {@link com.github.zkclient.IZkStateListener}
     */
     ...
     * {@link com.github.zkclient.IZkClient.DataUpdater} that is passed into this method, which returns the new content. The
     ...
     * @throws com.github.zkclient.exception.ZkInterruptedException
