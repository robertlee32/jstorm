...
/**
 * All listeners registered at the {@link com.github.zkclient.ZkClient} will be notified from this event thread.
 * This is to prevent dead-lock situations. The {@link com.github.zkclient.ZkClient} pulls some information out of
 * the {@link org.apache.zookeeper.ZooKeeper} events to signal {@link com.github.zkclient.ZkLock} conditions. Re-using the
 * {@link org.apache.zookeeper.ZooKeeper} event thread to also notify {@link com.github.zkclient.ZkClient} listeners, would stop the
 * ZkClient from receiving events from {@link org.apache.zookeeper.ZooKeeper} as soon as one of the listeners blocks
 * (because it is waiting for something). {@link com.github.zkclient.ZkClient} would then for instance not be able
